<main>
        <section>
            <div class="bg-1 img-fluid" style="background-image:linear-gradient(rgba(3, 3, 3, 0.5), rgba(0,0,0,0.5)),url('https://images.pexels.com/photos/1029757/pexels-photo-1029757.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'); background-position: center; background-size: cover; background-repeat:no-repeat;height: 60vmin; width: auto; display: flex; flex-direction: column; align-items: center; ">
                <h1 class="text-center pb-0" style="padding-top:23vmin; padding-bottom: 0%; font-size:4vmax; color:#DDF6F0; margin-top:10vmin;" ><span class="element3"></span></h1>
            </div>
                    ...
                    <div class="col-lg-12">
                        <ul class="nav nav-tabs mb-3 mt-3 ">
                          ...
                          <div class="tab-content" id="myTabContentNet">
                            ...
                            <!--Syllibus-->
                            <div class="tab-pane fade " id="courseNet" role="tabpanel" aria-labelledby="course-tabNet">
                                <div id="accordion">
                                    <div class="card">
        ...
        <section id="prospectJob" style="background-image: linear-gradient(rgba(3, 3, 3, 0.8), rgba(0,0,0,0.5)),url('https://images.unsplash.com/photo-1626903264858-be7e5653b8e9?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1032&q=80');" >
            <div class="container mt-0 prospectBg" >
                <h1 class="text-left pb-2">Career Prospect</h1>
                <div class="row">
                    <div class="col-lg-4 prospectJob">
                        <img src="https://images.pexels.com/photos/4549414/pexels-photo-4549414.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" class="img-fluid thumbnail jobPic">
                    </div>
                    <div class="col-lg-8 jobs">
                        <div class="row text-center" id="listJob">
                            <div class="col-lg-3 col-sm-12 ">
                                <p>Computer Animator</p>
                            </div>
                            <div class="col-lg-3 col-sm-12">
            ...
            <div class="container pb-sm-2">
                <p class="pt-3 pb-3 text-justify font-weight-bold mt-2 px-2" style="color:#FFF7ED; background-color: rgba(58, 56, 56, 0.486);"> 
                    Graduates of Bachelor of Computer Science (Multimedia Technology) with 
                    Honors will have the the ability to design, implement and manage 
                    IT solutions, resources and recognize the impact of technology on 
    ...
    <script>
        ...
        var typed= new Typed(".element3",{
            strings: ["HC12 MULTIMEDIA TECHNOLOGY", "UH6481003 Multimedia Technology","MULTIMEDIA TECHNOLOGY", "Teknologi Multimedia"],
            smartBackspace:true,
            typeSpeed:50,
            backSpeed:30,
            loop:true,
