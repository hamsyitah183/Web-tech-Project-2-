<main>
        <section>
            <div class="bg-1 img-fluid" style="background-image:linear-gradient(rgba(3, 3, 3, 0.5), rgba(0,0,0,0.5)),url('https://images.pexels.com/photos/8296974/pexels-photo-8296974.jpeg?auto=compress&cs=tinysrgb&w=600'); background-position: center; background-size: cover; height: 60vmin; width: auto; display: flex; flex-direction: column; align-items: center; ">
        ...
        <section id="prospectJob" style="background-image: linear-gradient(rgba(3, 3, 3, 0.8), rgba(0,0,0,0.5)),url('https://images.pexels.com/photos/3183150/pexels-photo-3183150.jpeg?auto=compress&cs=tinysrgb&w=600');" >
            <div class="container mt-0 prospectBg" >
                <h1 class="text-left pb-2">Career Prospect</h1>
                <div class="row">
                    <div class="col-lg-4 prospectJob">
                        <img src="https://images.pexels.com/photos/1181355/pexels-photo-1181355.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" class="img-fluid thumbnail jobPic">
                    </div>
            ...
            <div class="container pb-sm-2">
                <p class="pt-3 pb-3 text-justify font-weight-bold mt-2 px-2" style="color:#FFF7ED; background-color: rgba(58, 56, 56, 0.486);"> 
                    Graduates of Bachelor of Computer Science (Business Computing) with 
                    Honors will have the opportunity to Demonstrate knowledge and 
                    understanding of facts, concepts, principles, 
                    and theories related to Business Computing.
                </p>
            </div>
        </section>
    </main>
     ...
     <script>
        ...
        var typed= new Typed(".element2",{
            strings: ["HC13 Business Computing", "BUSINESS COMPUTING", "Komputeran Bisnes"],
            smartBackspace:true,
            typeSpeed:50,
            backSpeed:30,
            loop:true,
