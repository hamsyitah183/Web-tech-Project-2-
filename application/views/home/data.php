<main>
        <section>
            <div class="bg-1 img-fluid" style="background-image:linear-gradient(rgba(3, 3, 3, 0.5), rgba(0,0,0,0.5)),url('https://images.pexels.com/photos/2599244/pexels-photo-2599244.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1'); background-position: center; background-size: cover; height: 60vmin; width: auto; display: flex; flex-direction: column; align-items: center; ">
                <h1 class="text-center pb-0" style="padding-top:23vmin; padding-bottom: 0%; font-size:4vmax; color:#DDF6F0; margin-top:10vmin;" ><span class="element2"></span></h1>
            </div>
            
            <div class="container detail mt-lg-0" id="network-engineering" role="tablist">
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <ul class="nav nav-tabs mb-3 mt-3 ">
                            <li class="nav-item">
                                <a class="nav-link active" id="programme-tabNet" data-toggle="tab" href="#programmeNet" role="tab" aria-controls="programme" aria-selected="true">Programme Description</a>
                              </li>
                            <li class="nav-item">
                              <a class="nav-link" id="course-tabNet" data-toggle="tab" href="#courseNet" role="tab" aria-controls="course" aria-selected="false">Course structure</a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link" id="requirement-tabNet" data-toggle="tab" href="#requirementNet" role="tab" aria-controls="requirement" aria-selected="false" onclick="loadDoc()">Requirement</a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link" id="fee-tabNet" data-toggle="tab" href="#feeNet" role="tab" aria-controls="fee" aria-selected="false">Fee</a>
                            </li>
                            <li class="nav-item">
                              <a class="nav-link" id="apply-tabNet" data-toggle="tab" href="#applyNet" role="tab" aria-controls="apply" aria-selected="false">How to apply</a>
                            </li>
                          </ul>

                          <div class="tab-content" id="myTabContentNet">
                            <!---Programme Description-->
                            <div class="tab-pane fade show active" id="programmeNet" role="tabpanel" aria-labelledby="programme-tab" class="requirementBg" >
                            ...
                            <!--Syllibus-->
                            <div class="tab-pane fade show" id="courseNet" role="tabpanel" aria-labelledby="course-tabNet">
                                <div id="accordion">
                                    <div class="card">
                                      <div class="card-header" id="headingOneNet">
                                        <h5 class="mb-0">
                                          <button class="btn btn-link" data-toggle="collapse" data-target="#firstYearNet" aria-expanded="true" aria-controls="firstYearNet">
                                            <p>First year</p>
                                          </button>
                                        </h5>
                                      </div>
                                  
                                      <div id="firstYearNet" class="collapse" aria-labelledby="headingOneNet" data-parent="#accordion">
                                        <div class="card-body">
                                                    ...
                                                    <dl>
                                                        ...
                                                        <dd class="pl-lg-3 pl-sm-3 pl-md-3">
                                                            <ul>
                                                                <li>
                                                                    <dl>
                                                                        <dt>KD14203</dt> <dd>OOP for Data Science</dd>
                                                                    </dl>
                                                                   
                                                                </li>
                                                                <li>
                                                                    <dl>
                                                                        <dt>KD14403</dt> <dd>Fundamental of Data Science</dd>
                                                                    </dl>
                                    ...
                                    <div class="card">
                                      <div class="card-header" id="headingTwoNet">
                                        <h5 class="mb-0">
                                          <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#secondYearNet" aria-expanded="false" aria-controls="secondYearNet">
                                            <p>Second year</p>
                                          </button>
                                        </h5>
                                      </div>
                                      <div id="secondYearNet" class="collapse" aria-labelledby="headingTwoNet" data-parent="#accordion">
                                        <div class="card-body">
                                          <div class="row  px-lg-0 py-lg-0 mx-lg-0 my-lg-0 px-0 py-0 mx-0 my-0" style="font-size:small">
                                            <div class="col-lg-6 first-box">
                                                    <!--First semester-->
                                                ...
                                                <dl>
                                                    ...
                                                    <dd class="pl-lg-3 pl-sm-3 pl-md-3">
                                                        <ul>
                                                            <li>
                                                                <dl>
                                                                    <dt>KT24303</dt> <dd>Data Structure and
                                                                        Algorithms</dd>
                                                                </dl>
                                                            </li>
                                                            <li>
                                                ...
                                                <div class="col-lg-6 second-box">
                                                    <!--Second semester-->
                                                    <dl>
                                                        <dt class="pb-sm-2 second-box" style="border:none;">Semester 2</dt>
                                                        ...
                                                        <dd class="pl-lg-3 pl-sm-3 pl-md-3">
                                                            <ul>
                                                                <li>
                                                                    <dl>
                                                                        <dt>KT24403</dt> <dd>Operating System</dd>
                                                                    </dl>
                                                                </li>
                                                                <li>
                                                                    <dl>
                                                                        <dt>KT24602</dt> <dd>Software
                                                                            Engineering</dd>
                                                                    </dl>
                                                                </li>
                                                                ...
                                                                <li>
                                                                    <dl>
                                                                        <dt>KT24803</dt> <dd>Networking and
                                                                            Communication</dd>
                                                                    </dl>
                                                                </li>
                                                        ...
                                                        <dd class="pl-lg-3 pl-sm-3 pl-md-3">
                                                            <ul>
                                                                <li>
                                                                    <dl>
                                                                        <dt>KD24203</dt> <dd>Data Mining and
                                                                            Warehousing</dd>
                                                                    </dl>
                                    ...
                                    <div class="card">
                                      <div class="card-header" id="headingThreeNet">
                                        <h5 class="mb-0">
                                          <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#thirdYearNet" aria-expanded="false" aria-controls="thirdYearNet">
                                            Third Year
                                          </button>
                                        </h5>
                                      </div>
                                      <div id="thirdYearNet" class="collapse" aria-labelledby="headingThreeNet" data-parent="#accordion">
                                        <div class="card-body">
                                          <div class="row  px-lg-0 py-lg-0 mx-lg-0 my-lg-0 px-0 py-0 mx-0 my-0" style="font-size:small">
                                            <div class="col-lg-6 first-box">
                                                    <!--First semester-->
                                                ...
                                                <dl>
                                                    ...
                                                    <dd class="pl-lg-3 pl-sm-3 pl-md-3">
                                                        <ul>
                                                            <li>
                                                                <dl>
                                                                    <dt>KD34103</dt> <dd>Text Mining</dd>
                                                                </dl>
                                                                <dl>
                                                            </li>
                                                            <li>
                                                                    <dt>KD34303</dt> <dd>Internet of Things</dd>
                                                                </dl>
                                                            </li>
                                    ...
                                    <div class="card">
                                        <!--Fourth year-->
                                    <div class="card-header" id="headingFourNet">
                                        <h5 class="mb-0">
                                          <button class="btn btn-link" data-toggle="collapse" data-target="#fourthYearNet" aria-expanded="false" aria-controls="fourthYearNet">
                                            <p>Fourth year</p>
                                          </button>
                                        </h5>
                                      </div>
                                  
                                      <div id="fourthYearNet" class="collapse" aria-labelledby="headingFourNet" data-parent="#accordion">
                                        <div class="card-body">
                            ...
                            <div class="tab-pane fade" id="requirementNet" role="tabpanel" aria-labelledby="requirement-tab" class="requirementBg" style="background-color:#FFEACE;">
                                <div id="requirementNet"></div>
                            </div>
                            <div class="tab-pane fade" id="feeNet" role="tabpanel" aria-labelledby="fee-tab">
                            ...
                            <div class="tab-pane fade" id="applyNet" role="tabpanel" aria-labelledby="apply-tab">
                                <div class="container applyTabNet">
        ...
        <section id="prospectJob" style="background-image: linear-gradient(rgba(3, 3, 3, 0.8), rgba(0,0,0,0.5)),url('https://images.pexels.com/photos/590022/pexels-photo-590022.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1');" >
            <div class="container mt-0 prospectBg" >
                <h1 class="text-left pb-2">Career Prospect</h1>
                <div class="row">
                    <div class="col-lg-4 prospectJob">
                        <img src="https://images.pexels.com/photos/3913021/pexels-photo-3913021.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" class="img-fluid thumbnail jobPic">
                    </div>
            ...
            <div class="container pb-sm-2" id="courseOutcome">
                <p class="pt-3 pb-3 text-justify font-weight-bold mt-2 px-2" style="color:#FFF7ED; background-color: rgba(58, 56, 56, 0.486);"> 
                    Graduates of Bachelor of Computer Science (Data Science) with 
                    Honors will have the opportunity to venture into business, 
                    web development, database development, mobile application design, 
                    as well as research-related career 
...
<script>
        ...
        var typed= new Typed(".element2",{
            strings: ["HC14 Data Science", "UH6481005 DATA SCIENCE", "DATA SCIENCE", "Sains Data"],
            smartBackspace:true,
            typeSpeed:50,
            backSpeed:30,
            loop:true,
